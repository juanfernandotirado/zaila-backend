...
// This is to handle:
// Retrieve all artwork. example:  /api/artwork/
// Retrieve one artwork by sensorID. example:  /api/artwork?sensorId=12345ABCDE&language=en-US
router.get('/', artworkController.getAllArtwork);

// This is to handle:
// Retrieve One artwork (path variable id). Example: /api/artwork/:artworkId
// Retrieve one artwork by Artwork ID. example:  /api/artwork/:artworkId?language=en-US
