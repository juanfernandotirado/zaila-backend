...
router.post('/registerUser', userController.validateUser, userController.createUser)

//public endpoint to login / Sign In an existing user (JWT is created in this route if credentials are valid) 
router.post('/login', userController.validateLogin, userController.signInUser)
